...
- **name**: Human-readable screen name (e.g., "Welcome", "Create Account")

  **🚨 CRITICAL NAMING RULES FOR 'name' FIELD:**

  The `name` field will be converted to a React component name (e.g., `LoginScreen`), so it MUST follow these rules:

  1. **NO special characters**: No hyphens, ampersands, apostrophes, slashes, etc.
  2. **NO numbers at the start**: Don't start with numbers (e.g., "7-Day Plan" is invalid)
  ...
  **Examples of INVALID names (DO NOT USE):**
  ...
  - ❌ "Product & Cart" (has ampersand)
  - ❌ "Step-by-Step Guide" (has hyphens)
  - ❌ "User's Profile" (has apostrophe)
  - ❌ "3D View" (starts with number)
  - ❌ "7-Day Calendar" (starts with number, has hyphen)
  - ❌ "Settings/Profile" (has slash)

  **If you need to use these concepts, rephrase them:**

  - "Product & Cart" → "Product Cart"
  - "Step-by-Step Guide" → "Step by Step Guide"
  - "User's Profile" → "User Profile"
  - "3D View" → "Three Dimensional View"
  - "7-Day Calendar" → "Seven Day Calendar"
